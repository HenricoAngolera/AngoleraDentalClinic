...
<table class="table">
	<tr>
		<th colspan="6" style="text-align:center;"><h1>Consultas Confirmadas</h1></th>
	</tr>
	<tr>
...
<tr>
		...
		<td><?php echo $consulta['horafim'];?></td>
                ...
                <td><form action="" method="POST"><button type="button" class="btn btn-info">Pagou</button></form></td>
                </tr>
	<?php
	}
    ?>
