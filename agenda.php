...
<nav class="navbar navbar-expand-lg coco">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a style="font-size:18pt" class="nav-link corloca" href="agenda.php">Agendar Consulta</a>
                </li>
                <li class="nav-item">
                    <a style="font-size:18pt" class="nav-link corloca" href="mostraperfil.php">Ver Perfil</a>
                </li>
                <li class="nav-item">
