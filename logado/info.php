...
<body>
    <div id="container2">
        ...
        <table id="tabelinha">
            <tr>    
                <td colspan="2"><h1>Informações</h1></td>
            <tr/>
            <tr>
                <td class="centro">
                    <img src="../_imagens/clinica.jpg">  
                </td>    
                <td class="centro">
                    <h3 id="esse">Fale conosco:</h3>    
                    <br/><a>Telefone da clínica:(55)34228006</a>
                    <br/><a>Endereço: Rua dos Andradas 153</a>
                    <br/><a>Whatsapp: (55)999742349</a>
                </td>
            </tr>
            <tr>
                <td class="centro"><a>Dentista: Paulo Angolera</a>
                    <br/><a>ASB: Ivone Duarte Angolera</a>
                    <br/><a>Aluno: Henrico Angolera</a>
                    <br/><a>Orientadora: Aniele Severo Lisboa</a>
                    <br/><a class="forte">Ao lado, temos a foto do TCC</a><br/><a class="forte"> Ensino Médio junto com TI</a><br/><a class="forte">Do aluno Henrico Angolera</a><br/><a class="forte"> No IFF(Instituto Federal Farroupilha)</a>
                </td>
                <td class="centro">
                    <img id="imagen" src="../_imagens/outraft.jpg">
                </td>
            </tr>
        </table>
    </div>    
