...
<body>
        ...
        <fieldset>
            ...
            <div id="outro_campo">
                ...
                <p>Esse programa é uma adaptação do mesmo consultório que você já conhece,
                    ...
                    também a forma em que você faz seu agendamento, na nova <a id="bonito" style="color:#955A78;" style="font-style:oblique;">Angolera Dental Clinic</a>.</p>
                <h3>Começando?</h3>
            ...
            <aside>
                ...
                <form action="validar.php" method="POST">
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Inserir email" required autofocus>
                    </div>
                    <div class="form-group">
    ...
    <a id="secreto" href="cadastros.php">a</a>
